"""
Training script for CAGE Challenge 4 using RLlib APPO
APPO = Asynchronous Proximal Policy Optimization (distributed PPO)
"""
...
def train_agents(num_iterations=25, episode_length=500, checkpoint_dir="cage_appo_solution/trained_model"):
    """
    Train CAGE Challenge 4 agents using APPO
    """
    print(f"\n🎯 Training APPO: {num_iterations} iterations, episode length: {episode_length}")
    ...
    config = (
        ...
        .training(
            ...
            # PPO clipping
            clip_param=0.2,
            # HIGHER entropy for more exploration (reduce overfitting)
            entropy_coeff=0.1,
            ...
            minibatch_size=128,
            # FEWER epochs to reduce overfitting
            num_sgd_iter=5,
            # Gradient clipping
            grad_clip=0.5,
            # KL divergence - stricter to prevent overfitting
            kl_coeff=0.5,
            kl_target=0.005,
        ...
        .env_runners(
            # More workers for asynchronous training
            num_env_runners=4,
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Train CAGE Challenge 4 agents with APPO")
    ...
    parser.add_argument("--checkpoint-dir", type=str, default="cage_appo_solution/trained_model", help="Checkpoint directory")
