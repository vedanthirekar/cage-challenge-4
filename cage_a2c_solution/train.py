"""
Training script for CAGE Challenge 4 using Stable-Baselines3 A2C
...
class MultiAgentWrapper(gym.Env):
    ...
    def __init__(self, env):
        ...
        # Get observation and action spaces from first agent (all same for agents 0-3)
    ...
    def step(self, actions):
        ...
        actions: array of 5 action indices [a0, a1, a2, a3, a4]
        """
        # Convert combined actions to dict
        action_dict = {
            agent: int(actions[i])
        ...
        # Combine rewards (sum across all agents)
...
def train_a2c(total_timesteps=100000, checkpoint_dir="cage_a2c_solution/trained_model"):
    """Train A2C agent on CAGE Challenge 4"""

    print("\n" + "=" * 60)
    print("CAGE Challenge 4 - A2C Training")
    print("=" * 60)
    ...
    model = A2C(
        ...
        env,
        learning_rate=5e-4,
        n_steps=128,  # Number of steps before update
        gamma=0.99,
        gae_lambda=0.95,
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Train A2C on CAGE Challenge 4")
    parser.add_argument(
        "--timesteps",
        type=int,
        default=100000,
    ...
    parser.add_argument(
        "--checkpoint-dir",
        type=str,
        default="cage_a2c_solution/trained_model",
